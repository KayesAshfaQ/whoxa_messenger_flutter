                      ...
                      actions: <Widget>[
                        ...
                        Container(
                          ...
                          child: IconButton(
                              padding: const EdgeInsets.all(0),
                              onPressed: () {
                                print('Group voice call pressed');
                                groupVoiceCall();
                              },
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  errorWidget: (context, url, error) =>
                                      Material(
                                    child:
                                        Center(child: Text("Not Avilable".tr)),
                                    borderRadius: BorderRadius.all(
                                      Radius.circular(8.0),
                                    ),
        ...
        if (doc.data["mute"] != null && doc.data["mute"] != true) {
          database
            ...
            if (type == 1) {
              ...
              sendNotification(peerData.value['token'], content, true);
            }
          });
        }
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return
                  ...
                  // lists[index]["userId"].contains(widget.currentuser)
                  //     ?
                          ...
                          leading: new Stack(
                            children: <Widget>[
                              (lists[index]["castImage"] != null &&
                                      lists[index]["castImage"].length > 0)
                                  ? CircleAvatar(
                                      backgroundColor: Colors.grey,
                                      backgroundImage: new NetworkImage(
                                  ...
                                  : CircleAvatar(
                                      backgroundColor: Colors.grey[300],
                                      child: Text(
                                        lists[index]["castName"][0].toString(),
                                        style: TextStyle(
                                            color: Colors.green,
                                            fontSize: 20,
                                            fontWeight: FontWeight.bold),
                          ...
                          child: IconButton(
                            onPressed: () {
                              setState1(() {
                                ...
                                groupMsgUserId
                                    .remove(jsonEncode(lists[index]["userId"]));
                                groupMsgPeerName
                      ...
                      : IconButton(
                          onPressed: () {
                            setState1(() {
                              ...
                              groupMsgUserId
                                  .add(jsonEncode(lists[index]["userId"]));
                              // groupMsgUserId
                              //     .add(lists[index]["userId"].toString());
                              groupMsgPeerName.add(lists[index]["castName"]);
                              groupMsgPeerImage.add(lists[index]["castImage"]);
                              print(groupMsgUserId);
                            });
                          },
                          icon: Icon(
